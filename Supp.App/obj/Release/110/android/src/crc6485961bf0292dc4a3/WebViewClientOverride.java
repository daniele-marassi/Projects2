...
public class WebViewClientOverride
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Supp.App.WebViewClientOverride, Supp.App", WebViewClientOverride.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == WebViewClientOverride.class) {
			mono.android.TypeManager.Activate ("Supp.App.WebViewClientOverride, Supp.App", "", this, new java.lang.Object[] {  });
		}
	}
