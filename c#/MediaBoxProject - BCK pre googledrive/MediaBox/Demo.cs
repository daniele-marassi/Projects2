...
namespace MediaBox
{
    public class Demo
    {
        ...
        public void SetDirectories(Form form)
        {
            ...
            emulationMousePointer.MoveToControl(form, "OpenCloseManageDirectoryBtn");
            Button OpenCloseManageDirectoryBtn = (Button)utility.GetControlByChildName(form, "OpenCloseManageDirectoryBtn");

            emulationMousePointer.ShowTooltip(common.GetTraslation(OpenCloseManageDirectoryBtn.Name), Color.FromArgb(255, 255, 255, 255), Color.FromArgb(255, 0, 0, 0));
            System.Threading.Thread.Sleep(2000);
            emulationMousePointer.CloseTooltip();

            emulationMousePointer.ClickDown(true);
            LeftPnl.Enabled = true;
            OpenCloseManageDirectoryBtn.PerformClick();
            LeftPnl.Enabled = false;
            emulationMousePointer.ClickUp(true);
            ...
            System.Threading.Thread.Sleep(500);
            emulationMousePointer.MoveToControl(form, "DirectoryAddBtn");
            Button DirectoryAddBtn = (Button)utility.GetControlByChildName(form, "DirectoryAddBtn");
            LeftPnl.Enabled = true;
            emulationMousePointer.ClickDown(true);
            DirectoryAddBtn.PerformClick();
            emulationMousePointer.ClickUp(true);
            LeftPnl.Enabled = false;
            ...
            emulationMousePointer.MoveToControl(form, "DirectoryList");
            ListBox DirectoryList = (ListBox)utility.GetControlByChildName(form, "DirectoryList");
            
            emulationMousePointer.ShowTooltip(common.GetTraslation(DirectoryList.Name + "Demo"), Color.FromArgb(255, 255, 255, 255), Color.FromArgb(255, 0, 0, 0));
            System.Threading.Thread.Sleep(2000);
            emulationMousePointer.CloseTooltip();
            ...
            LeftPnl.Enabled = true;
            emulationMousePointer.ClickDown(true);
            DirectoryList.SelectedIndex = 2;
            emulationMousePointer.ClickUp(true);
            LeftPnl.Enabled = false;

            System.Threading.Thread.Sleep(500);
            emulationMousePointer.MoveToControl(form, "DirectoryDelBtn");
            Button DirectoryDelBtn = (Button)utility.GetControlByChildName(form, "DirectoryDelBtn");
            LeftPnl.Enabled = true;
            emulationMousePointer.ClickDown(true);
            DirectoryDelBtn.PerformClick();
            emulationMousePointer.ClickUp(true);
            LeftPnl.Enabled = false;
