CREATE TABLE IF NOT EXISTS `Configuration` (
	...
	`MediaInterval`	DOUBLE NOT NULL DEFAULT 0,
...
INSERT INTO `Translater` (`Name`,`IDLanguage`,`Text`) VALUES ('MediaIntervalLbl',1,'Attesa Media (secondi)');
INSERT INTO `Translater` (`Name`,`IDLanguage`,`Text`) VALUES ('MediaIntervalLbl',2,'Media Wait (sedonds)');
...
INSERT INTO `Translater` (`Name`,`IDLanguage`,`Text`) VALUES ('MediaIntervalTxtDemo',1,'Digitare i secondi di attesa tra la visualizzazione di un elemento multimediale e quello successivo');
INSERT INTO `Translater` (`Name`,`IDLanguage`,`Text`) VALUES ('MediaIntervalTxtDemo',2,'Type the seconds to wait between the display of a media element and the next one');
...
INSERT INTO `Configuration` (`WidthPanel`,`HeightPanel`, `CountElements`,`BackGrondColorMain`,`ForeColor`,`BorderColorMedia`,`DefaultPictureSize`,`WidthBorder`,`nPicturesOverPanel`,`MediaInterval`,`WidthBorderMedia`,`AutoRunAnimationMedia`,`VolumeAudio`,`Demo`,`IDLanguage`) VALUES (100,100,0,'250,250,250','30,30,30','255,255,255',100,4,2,3,5,0,10,0,1);