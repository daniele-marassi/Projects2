...
namespace Additional
{
    ...
    public static partial class HookManager
    {
        ...
        private static bool getKeyPress = false;
        private static bool getKeyUp = false;
        private static bool getKeyDown = false;
        private static string _key = String.Empty;
        private static string _project_Domain_Class_KeyPress = String.Empty;
        private static string _methodName_KeyPress = String.Empty;
        private static string _project_Domain_Class_KeyUp = String.Empty;
        private static string _methodName_KeyUp = String.Empty;
        private static string _project_Domain_Class_KeyDown = String.Empty;
        private static string _methodName_KeyDown = String.Empty;

        public static void EnableKeyPressHook(string project_Domain_Class, string methodName)
        {
            _project_Domain_Class_KeyPress = project_Domain_Class;
            _methodName_KeyPress = methodName;
        ...
        public static void EnableKeyUpHook(string project_Domain_Class, string methodName)
        {
            _project_Domain_Class_KeyUp = project_Domain_Class;
            _methodName_KeyUp = methodName;
            EnsureSubscribedToGlobalKeyboardEvents();
            getKeyUp = true;
        }
        ...
        public static void EnableKeyDownHook(string project_Domain_Class, string methodName)
        {
            _project_Domain_Class_KeyDown = project_Domain_Class;
            _methodName_KeyDown = methodName;
            EnsureSubscribedToGlobalKeyboardEvents();
            getKeyDown = true;
        }
