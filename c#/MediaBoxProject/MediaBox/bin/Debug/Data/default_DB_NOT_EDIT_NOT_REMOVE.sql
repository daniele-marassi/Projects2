...
INSERT INTO `Translater` (`Name`,`IDLanguage`,`Text`) VALUES ('OpenCloseManageSourceBtn',1,'Gestione dei cataloghi multimediali');
INSERT INTO `Translater` (`Name`,`IDLanguage`,`Text`) VALUES ('OpenCloseManageSourceBtn',2,'Management of multimedia catalogs');
...
INSERT INTO `Translater` (`Name`,`IDLanguage`,`Text`) VALUES ('AccountDriveTxt',1,'Account Drive');
INSERT INTO `Translater` (`Name`,`IDLanguage`,`Text`) VALUES ('AccountDriveTxt',2,'Account Drive');

INSERT INTO `Translater` (`Name`,`IDLanguage`,`Text`) VALUES ('PathAuthenticateJsonToDriveTxt',1,'File autenticazione Json');
INSERT INTO `Translater` (`Name`,`IDLanguage`,`Text`) VALUES ('PathAuthenticateJsonToDriveTxt',2,'Path authenticate Json');

INSERT INTO `Translater` (`Name`,`IDLanguage`,`Text`) VALUES ('FolderNameToFilterDriveTxt',1,'Cartella su cui filtrare');
INSERT INTO `Translater` (`Name`,`IDLanguage`,`Text`) VALUES ('FolderNameToFilterDriveTxt',2,'Folder name to Filter');
...
INSERT INTO `Translater` (`Name`,`IDLanguage`,`Text`) VALUES ('SourceListDemo',1,'Selezionare la voce che si vuole eliminare');
INSERT INTO `Translater` (`Name`,`IDLanguage`,`Text`) VALUES ('SourceListDemo',2,'Select the item you want to delete');
