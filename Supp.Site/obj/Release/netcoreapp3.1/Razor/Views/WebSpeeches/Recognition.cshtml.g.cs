#pragma checksum "E:\GoogleDriveShare\Projects\Supp.Site\Views\WebSpeeches\Recognition.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0171d94b36d66f3968559a7348a0d33fbd0b003a"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0171d94b36d66f3968559a7348a0d33fbd0b003a", @"/Views/WebSpeeches/Recognition.cshtml")]
...
#nullable disable
        ...
        function ReadOutLoud(message) {
            ...
            speech.lang = '");
#nullable restore
#line 187 "E:\GoogleDriveShare\Projects\Supp.Site\Views\WebSpeeches\Recognition.cshtml"
                      Write(Model?.Culture);
...
#nullable restore
#line 230 "E:\GoogleDriveShare\Projects\Supp.Site\Views\WebSpeeches\Recognition.cshtml"
...
#nullable disable
        ...
        function InitPage(){
            ...
            try {
                ehi=parseInt('");
#nullable restore
#line 270 "E:\GoogleDriveShare\Projects\Supp.Site\Views\WebSpeeches\Recognition.cshtml"
                         Write(Model?.Ehi);
...
#nullable restore
#line 275 "E:\GoogleDriveShare\Projects\Supp.Site\Views\WebSpeeches\Recognition.cshtml"
               Write(Model?.Phrase);
...
#nullable restore
#line 277 "E:\GoogleDriveShare\Projects\Supp.Site\Views\WebSpeeches\Recognition.cshtml"
                               Write(Model?.Phrase);
...
#nullable restore
#line 285 "E:\GoogleDriveShare\Projects\Supp.Site\Views\WebSpeeches\Recognition.cshtml"
                                                                                                 Write(Model?.HostSelected);
        ...
        function SendPhrase(){
            if(_reset == false){
                ...
                if(_phrase != null && _phrase != ''){
                    ...
                    location.href = '");
#nullable restore
#line 303 "E:\GoogleDriveShare\Projects\Supp.Site\Views\WebSpeeches\Recognition.cshtml"
...
#nullable disable
        ...
        function StartButton(event) {
            ...
            recognition.lang = '");
#nullable restore
#line 330 "E:\GoogleDriveShare\Projects\Supp.Site\Views\WebSpeeches\Recognition.cshtml"
                           Write(Model?.Culture);
...
#nullable disable
            WriteLiteral(@"' && ehi == 0 && _reset == false) {
                                            ...
                                            var phrase = '");
#nullable restore
#line 403 "E:\GoogleDriveShare\Projects\Supp.Site\Views\WebSpeeches\Recognition.cshtml"
                                                     Write(Model?.ListeningWord1);
...
#nullable disable
            WriteLiteral("\';\r\n                                            PartialReset();\r\n                                            clearInterval(serviceInterval);\r\n                                            location.href = \'");
#nullable restore
#line 406 "E:\GoogleDriveShare\Projects\Supp.Site\Views\WebSpeeches\Recognition.cshtml"
                                                        Write(Url.Action("Recognition", "WebSpeeches"));
...
#nullable disable
            WriteLiteral(@"';
                                            ...
                                            location.href = '");
#nullable restore
#line 412 "E:\GoogleDriveShare\Projects\Supp.Site\Views\WebSpeeches\Recognition.cshtml"
                                                        Write(Url.Action("Recognition", "WebSpeeches"));
...
#nullable disable
        ...
        function FakeClick(){
            if (answer != null && answer != '') { 
                ");
            WriteLiteral(@"ReadOutLoud(answer); 
                answer = null;
            } else {
                PartialReset();
            }
        ...
        function Reset(){
            ...
            if(_reset == false){ 
                ...
                location.href = '");
#nullable restore
#line 499 "E:\GoogleDriveShare\Projects\Supp.Site\Views\WebSpeeches\Recognition.cshtml"
                            Write(Url.Action("Recognition", "WebSpeeches"));
...
#nullable disable
        ...
        function InitFinal(){
            ...
            //var shortcuts = new Array('{""Id"":""1"", ""I");
            WriteLiteral(@"co"":""/Images/application.png"", ""Title"":""Test 1"", ""Action"":""app""}', '{""Id"":""2"", ""Ico"":""/Images/application.png"", ""Title"":""Test 2"", ""Action"":""app""}', '{""Id"":""3"", ""Ico"":""/Images/application.png"", ""Title"":""Test 3"", ""Action"":""app""}', '{""Id"":""4"", ""Ico"":""/Images/application.png"", ""Title"":""Test 4"", ""Action"":""app""}', '{""Id"":""5"", ""Ico"":""/Images/application.png"", ""Title"":""Test 5"", ""Action"":""app""}', '{""Id"":""6"", ""Ico"":""/Images/application.png"", ""Title"":""Test 6"", ""Action"":""app""}', '{""Id"":""7"", ""Ico"":""/Images/application.png"", ""Title"":""Test 7"", ""Action"":""app""}');
            var shortcutsInJson = ('");
#nullable restore
#line 529 "E:\GoogleDriveShare\Projects\Supp.Site\Views\WebSpeeches\Recognition.cshtml"
       ...
       ");
            ...
            for (var i = 0; i < shortcuts.length; ++i) {
                ...
                if(shortcut['Id'] == parseInt(id)){
                    ...
                    //if(GetBoolean(application) == true && shortcut['Type'] == 'xxx' ){
                    //}

                    //if(GetBoolean(application) == false && shortcut['Type'] == 'xxx' ){
                    //}                
                }
            }
        }
...
");
#nullable restore
#line 633 "E:\GoogleDriveShare\Projects\Supp.Site\Views\WebSpeeches\Recognition.cshtml"
}
...
<div id=""main"">
  ...
  ");
        ...
        <div id=""div_text"" style=""text-align:center; width:100%; margin-top:2px;"">
            ...
            BeginWriteAttribute("value", " value=\"", 28222, "\"", 28230, 0);
            EndWriteAttribute();
