intellisense.annotate(jQuery, {
  ...
  'Deferred': function() {
    /// <signature>
    ///   <summary>A constructor function that returns a chainable suppUtility object with methods to register multiple callbacks into callback queues, invoke callback queues, and relay the success or failure state of any synchronous or asynchronous function.</summary>
...
intellisense.annotate(_object, {
  ...
  'pipe': function() {
    /// <signature>
    ///   <summary>SuppUtility method to filter and/or chain Deferreds.</summary>
