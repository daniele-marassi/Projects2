        ...
        public async Task<UserRoleResult> GetAllUserRoles(string token)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                ...
                try
                {
                    ...
                    var result = await utility.CallApi(HttpMethod.Get, GeneralSettings.Static.BaseUrl, "api/UserRoles/GetAllUserRoles", keyValuePairs, token);
        ...
        public async Task<UserRoleResult> GetUserRolesById(long id, string token)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                ...
                try
                {
                    ...
                    var result = await utility.CallApi(HttpMethod.Get, GeneralSettings.Static.BaseUrl, "api/UserRoles/GetUserRole", keyValuePairs, token);
                    var content = await result.Content.ReadAsStringAsync();
        ...
        public async Task<UserRoleResult> UpdateUserRole(UserRoleDto dto, string token)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                ...
                try
                {
                    ...
                    var result = await utility.CallApi(HttpMethod.Put, GeneralSettings.Static.BaseUrl, "api/UserRoles/UpdateUserRole", keyValuePairs, token);
                    var content = await result.Content.ReadAsStringAsync();
        ...
        public async Task<UserRoleResult> AddUserRole(UserRoleDto dto, string token)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                ...
                try
                {
                    ...
                    var result = await utility.CallApi(HttpMethod.Post, GeneralSettings.Static.BaseUrl, "api/UserRoles/AddUserRole", keyValuePairs, token);
                    var content = await result.Content.ReadAsStringAsync();
        ...
        public async Task<UserRoleResult> DeleteUserRoleById(long id, string token)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                ...
                try
                {
                    ...
                    var result = await utility.CallApi(HttpMethod.Delete, GeneralSettings.Static.BaseUrl, "api/UserRoles/DeleteUserRole", keyValuePairs, token);
                    var content = await result.Content.ReadAsStringAsync();
