        ...
        public async Task<UserResult> GetAllUsers(string token)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                ...
                try
                {
                    ...
                    var result = await utility.CallApi(HttpMethod.Get, GeneralSettings.Static.BaseUrl, "api/Users/GetAllUsers", keyValuePairs, token);
        ...
        public async Task<UserResult> GetUsersById(long id, string token)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                ...
                try
                {
                    ...
                    var result = await utility.CallApi(HttpMethod.Get, GeneralSettings.Static.BaseUrl, "api/Users/GetUser", keyValuePairs, token);
                    var content = await result.Content.ReadAsStringAsync();
        ...
        public async Task<UserResult> UpdateUser(UserDto dto, string token)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                ...
                try
                {
                    ...
                    var result = await utility.CallApi(HttpMethod.Put, GeneralSettings.Static.BaseUrl, "api/Users/UpdateUser", keyValuePairs, token);
                    var content = await result.Content.ReadAsStringAsync();
        ...
        public async Task<UserResult> AddUser(UserDto dto, string token)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                ...
                try
                {
                    ...
                    var result = await utility.CallApi(HttpMethod.Post, GeneralSettings.Static.BaseUrl, "api/Users/AddUser", keyValuePairs, token);
                    var content = await result.Content.ReadAsStringAsync();
        ...
        public async Task<UserResult> DeleteUserById(long id, string token)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                ...
                try
                {
                    ...
                    var result = await utility.CallApi(HttpMethod.Delete, GeneralSettings.Static.BaseUrl, "api/Users/DeleteUser", keyValuePairs, token);
                    var content = await result.Content.ReadAsStringAsync();
