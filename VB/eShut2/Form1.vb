Public Class Form1
    ...
    Private Sub Form1_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        l1 = Button1.Location.X
        l2 = Button2.Location.X
        l3 = Button3.Location.X
        l4 = Button4.Location.X
        l5 = Button5.Location.X
        l6 = Button6.Location.X
        t1 = Button1.Location.Y
        t2 = Button2.Location.Y
        t3 = Button3.Location.Y
        t4 = Button4.Location.Y
        t5 = Button5.Location.Y
        t6 = Button6.Location.Y


        y = ScreenResolution()
        Me.Location = New Point(125, 1080)
    ...
    Private Sub Timer1_Tick(sender As System.Object, e As System.EventArgs) Handles Timer1.Tick
        Button1.Location = New Point(l1 + (Rnd() * 10), t1 + (Rnd() * 10))
        Button6.Location = New Point(l6 + (Rnd() * 10), t6 + (Rnd() * 10))
        Button2.Location = New Point(l2 + (Rnd() * 10), t2 + (Rnd() * 10))
        Button3.Location = New Point(l3 + (Rnd() * 10), t3 + (Rnd() * 10))
        Button4.Location = New Point(l4 + (Rnd() * 10), t4 + (Rnd() * 10))
        Button5.Location = New Point(l5 + (Rnd() * 10), t5 + (Rnd() * 10))
    End Sub
    ...
    Private Sub Timer2_Tick(sender As System.Object, e As System.EventArgs) Handles Timer2.Tick
        If y1 < 12 Then
            ...
            Me.Location = New Point(120, y + 10)
