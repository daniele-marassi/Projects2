USE [master]
GO
/****** Object:  Database [Supp.DataBase]    Script Date: 01/11/2023 10:16:43 ******/
...
USE [Supp.DataBase]
GO
/****** Object:  User [Admin]    Script Date: 01/11/2023 10:16:44 ******/
CREATE USER [Admin] FOR LOGIN [Admin] WITH DEFAULT_SCHEMA=[dbo]
GO
/****** Object:  Schema [auth]    Script Date: 01/11/2023 10:16:44 ******/
CREATE SCHEMA [auth]
GO
/****** Object:  Table [auth].[Authentications]    Script Date: 01/11/2023 10:16:44 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [auth].[Tokens]    Script Date: 01/11/2023 10:16:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [auth].[UserRoles]    Script Date: 01/11/2023 10:16:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [auth].[UserRoleTypes]    Script Date: 01/11/2023 10:16:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [auth].[Users]    Script Date: 01/11/2023 10:16:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ExecutionQueues]    Script Date: 01/11/2023 10:16:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[GoogleAccounts]    Script Date: 01/11/2023 10:16:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[GoogleAuths]    Script Date: 01/11/2023 10:16:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Media]    Script Date: 01/11/2023 10:16:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MediaConfigurations]    Script Date: 01/11/2023 10:16:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Songs]    Script Date: 01/11/2023 10:16:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[WebSpeeches]    Script Date: 01/11/2023 10:16:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [auth].[Tokens] ([Id], [UserId], [TokenCode], [ExpiryDate], [ExpiresInSeconds], [UserName], [RolesInJson], [Name], [Surname], [ConfigInJson], [InsDateTime]) VALUES (32798, 5, N'5|', NULL, 31572380, N'daniele.marassi.ev.tb@gmail.com', N'["User","SuperUser"]', N'Daniele', N'Marassi', N'{"General":{"PageSize":"5","Culture":"it-IT"},"Speech":{"HostsArray":"[\"EV-PC\",\"EV-TB\"]","HostDefault":"EV-TB","ListeningWord1":"","ListeningWord2":"cortana","ListeningAnswer":"si dimmi",/*Salutation - If it contains the key ''NAME'' it will be replaced with your profile name. If it contains the key ''SURNAME'' it will be replaced with your profile surname.*/"Salutation":"Ehi NAME",/*MeteoParameterToTheSalutation - empty to disable it.*/"MeteoParameterToTheSalutation":"trieste-oggi-32006","DescriptionMeteoToTheSalutationActive": "True","RemindersActive": "True", "TimeToResetInSeconds": 172800, "TimeToEhiTimeoutInSeconds": 15, "WakeUpScreenAfterEhiActive": "True", "GoogleCalendarAccount": "daniele.marassi"}}', CAST(N'2023-11-01T10:06:20.803' AS DateTime))
...
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (26, N'Spotify:_Tango_Nuevo', N'[["spotify"],["tango"],["nuevo"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs', N'spotify:user:dm:playlist:36A11xexKdLaMZWpUzLq2O', N'All', NULL, 1, 4, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:56:31.000' AS DateTime), 1, N'Spotify', 0, 0)
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (27, N'Spotify:_Tango_Tradizionale', N'[["spotify"],["tango"],["tradizionale"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs', N'spotify:user:dm:playlist:2LOKmWnLCkiizHwiljfhX9', N'All', NULL, 1, 4, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:57:48.000' AS DateTime), 1, N'Spotify', 0, 0)
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (28, N'Spotify:_2000', N'[["spotify"], ["2000"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs', N'spotify:user:dm:playlist:3W4uVzChUd70KYwpAJEBDo', N'All', NULL, 1, 4, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:59:01.000' AS DateTime), 1, N'Spotify', 0, 0)
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__UserRole__F9B8A48B5D9B3C08]    Script Date: 01/11/2023 10:16:51 ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__UserRole__F9B8A48BD16EC4B7]    Script Date: 01/11/2023 10:16:51 ******/
ALTER TABLE [auth].[UserRoleTypes] ADD UNIQUE NONCLUSTERED 
(
	[Type] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__Users__C9F28456571BFA96]    Script Date: 01/11/2023 10:16:51 ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__Users__C9F2845683FCF02F]    Script Date: 01/11/2023 10:16:51 ******/
ALTER TABLE [auth].[Users] ADD UNIQUE NONCLUSTERED 
(
	[UserName] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__WebSpeec__A20D0832FFBD5F5E]    Script Date: 01/11/2023 10:16:51 ******/
