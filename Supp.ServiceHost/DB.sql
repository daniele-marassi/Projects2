USE [master]
GO
/****** Object:  Database [Supp.DataBase]    Script Date: 08/02/2025 16:28:54 ******/
...
USE [Supp.DataBase]
GO
/****** Object:  User [Admin]    Script Date: 08/02/2025 16:28:54 ******/
CREATE USER [Admin] WITHOUT LOGIN WITH DEFAULT_SCHEMA=[dbo]
GO
/****** Object:  Schema [auth]    Script Date: 08/02/2025 16:28:54 ******/
CREATE SCHEMA [auth]
GO
/****** Object:  Table [auth].[Authentications]    Script Date: 08/02/2025 16:28:54 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [auth].[Tokens]    Script Date: 08/02/2025 16:28:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [auth].[UserRoles]    Script Date: 08/02/2025 16:28:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [auth].[UserRoleTypes]    Script Date: 08/02/2025 16:28:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [auth].[Users]    Script Date: 08/02/2025 16:28:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ExecutionQueues]    Script Date: 08/02/2025 16:28:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[GoogleAccounts]    Script Date: 08/02/2025 16:28:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[GoogleAuths]    Script Date: 08/02/2025 16:28:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Media]    Script Date: 08/02/2025 16:28:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MediaConfigurations]    Script Date: 08/02/2025 16:28:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Songs]    Script Date: 08/02/2025 16:28:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[WebSpeeches]    Script Date: 08/02/2025 16:28:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [auth].[Tokens] ([Id], [UserId], [TokenCode], [ExpiryDate], [ExpiresInSeconds], [UserName], [RolesInJson], [Name], [Surname], [ConfigInJson], [InsDateTime]) VALUES (27, 8, N'8|', NULL, 31617813, N'daniele.marassi.phone1@gmail.com', N'["User","SuperUser"]', N'Daniele', N'Marassi', N'{"General":{"PageSize":"5","Culture":"it-IT"},"Speech":{"HostsArray":"[\"Salotto\",\"Soggiorno\"]","HostDefault":"Salotto","ListeningWord1":"Ehi","ListeningWord2":"cortana","ListeningAnswer":"si dimmi",/*Salutation - If it contains the key ''NAME'' it will be replaced with your profile name. If it contains the key ''SURNAME'' it will be replaced with your profile surname.*/"Salutation":"Ehi NAME",/*MeteoParameterToTheSalutation - empty to disable it.*/"MeteoParameterToTheSalutation":"","DescriptionMeteoToTheSalutationActive": "True","RemindersActive": "False", "TimeToResetInSeconds": 172800, "TimeToEhiTimeoutInSeconds": 15, "WakeUpScreenAfterEhiActive": "False", "GoogleCalendarAccount": "daniele.marassi", "MessagingActive": "False", "NicknamesInJson":"[\"NAME\",\"Amore\"]"}}', CAST(N'2025-02-04T22:43:33.857' AS DateTime))
GO
INSERT [auth].[Tokens] ([Id], [UserId], [TokenCode], [ExpiryDate], [ExpiresInSeconds], [UserName], [RolesInJson], [Name], [Surname], [ConfigInJson], [InsDateTime]) VALUES (50, 5, N'5|', NULL, 31599222, N'daniele.marassi.ev.tb@gmail.com', N'["User","SuperUser"]', N'Daniele', N'Marassi', N'{"General":{"PageSize":"5","Culture":"it-IT"},"Speech":{"HostsArray":"[\"Salotto\",\"Soggiorno\"]","HostDefault":"Soggiorno","ListeningWord1":"Ok","ListeningWord2":"Soggiorno","ListeningAnswer":"si dimmi",/*Salutation - If it contains the key ''NAME'' it will be replaced with your profile name. If it contains the key ''SURNAME'' it will be replaced with your profile surname.*/"Salutation":"Ehi NAME",/*MeteoParameterToTheSalutation - empty to disable it.*/"MeteoParameterToTheSalutation":"","DescriptionMeteoToTheSalutationActive": "True","RemindersActive": "False", "TimeToResetInSeconds": 172800, "TimeToEhiTimeoutInSeconds": 15, "WakeUpScreenAfterEhiActive": "True", "GoogleCalendarAccount": "daniele.marassi", "MessagingActive": "True", "NicknamesInJson":"[\"NAME\",\"Amore\"]"}}', CAST(N'2025-02-07T17:33:42.213' AS DateTime))
GO
INSERT [auth].[Tokens] ([Id], [UserId], [TokenCode], [ExpiryDate], [ExpiresInSeconds], [UserName], [RolesInJson], [Name], [Surname], [ConfigInJson], [InsDateTime]) VALUES (51, 9, N'9|', NULL, 31546908, N'daniele.marassi.service1@gmail.com', N'["User","SuperUser"]', N'Daniele', N'Marassi', N'{"General":{"PageSize":"5","Culture":"it-IT"},"Speech":{"HostsArray":"[\"Salotto\",\"Soggiorno\"]","HostDefault":"Soggiorno","ListeningWord1":"Ehi","ListeningWord2":"cortana","ListeningAnswer":"si dimmi",/*Salutation - If it contains the key ''NAME'' it will be replaced with your profile name. If it contains the key ''SURNAME'' it will be replaced with your profile surname.*/"Salutation":"Ehi NAME",/*MeteoParameterToTheSalutation - empty to disable it.*/"MeteoParameterToTheSalutation":"","DescriptionMeteoToTheSalutationActive": "True","RemindersActive": "False", "TimeToResetInSeconds": 172800, "TimeToEhiTimeoutInSeconds": 15, "WakeUpScreenAfterEhiActive": "True", "GoogleCalendarAccount": "daniele.marassi", "MessagingActive": "False", "NicknamesInJson":"[\"NAME\",\"Amore\"]"}}', CAST(N'2025-02-08T03:01:48.327' AS DateTime))
GO
INSERT [auth].[Tokens] ([Id], [UserId], [TokenCode], [ExpiryDate], [ExpiresInSeconds], [UserName], [RolesInJson], [Name], [Surname], [ConfigInJson], [InsDateTime]) VALUES (53, 4, N'4|', NULL, 31595157, N'daniele.marassi@gmail.com', N'["User","SuperUser"]', N'Daniele', N'Marassi', N'{"General":{"PageSize":"5","Culture":"it-IT"},"Speech":{"HostsArray":"[\"Salotto\",\"Soggiorno\"]","HostDefault":"Salotto","ListeningWord1":"Ok","ListeningWord2":"Salotto","ListeningAnswer":"si dimmi",/*Salutation - If it contains the key ''NAME'' it will be replaced with your profile name. If it contains the key ''SURNAME'' it will be replaced with your profile surname.*/"Salutation":"",/*MeteoParameterToTheSalutation - empty to disable it.*/"MeteoParameterToTheSalutation":"","DescriptionMeteoToTheSalutationActive": "True","RemindersActive": "False", "TimeToResetInSeconds": 172800, "TimeToEhiTimeoutInSeconds": 15, "WakeUpScreenAfterEhiActive": "False", "GoogleCalendarAccount": "daniele.marassi", "MessagingActive": "False", "NicknamesInJson":"[\"NAME\",\"Amore\"]"}}', CAST(N'2025-02-08T16:25:57.913' AS DateTime))
GO
...
GO
INSERT [auth].[Users] ([Id], [UserName], [Name], [Surname], [CustomizeParams], [InsDateTime]) VALUES (4, N'daniele.marassi@gmail.com', N'Daniele', N'Marassi', N'{"General":{"PageSize":"5","Culture":"it-IT"},"Speech":{"HostsArray":"[\"Salotto\",\"Soggiorno\"]","HostDefault":"Salotto","ListeningWord1":"Ok","ListeningWord2":"Salotto","ListeningAnswer":"si dimmi",/*Salutation - If it contains the key ''NAME'' it will be replaced with your profile name. If it contains the key ''SURNAME'' it will be replaced with your profile surname.*/"Salutation":"",/*MeteoParameterToTheSalutation - empty to disable it.*/"MeteoParameterToTheSalutation":"","DescriptionMeteoToTheSalutationActive": "True","RemindersActive": "False", "TimeToResetInSeconds": 172800, "TimeToEhiTimeoutInSeconds": 15, "WakeUpScreenAfterEhiActive": "False", "GoogleCalendarAccount": "daniele.marassi", "MessagingActive": "False", "NicknamesInJson":"[\"NAME\",\"Amore\"]"}}', CAST(N'2021-04-28T22:15:21.000' AS DateTime))
GO
INSERT [auth].[Users] ([Id], [UserName], [Name], [Surname], [CustomizeParams], [InsDateTime]) VALUES (5, N'daniele.marassi.ev.tb@gmail.com', N'Daniele', N'Marassi', N'{"General":{"PageSize":"5","Culture":"it-IT"},"Speech":{"HostsArray":"[\"Salotto\",\"Soggiorno\"]","HostDefault":"Soggiorno","ListeningWord1":"Ok","ListeningWord2":"Soggiorno","ListeningAnswer":"si dimmi",/*Salutation - If it contains the key ''NAME'' it will be replaced with your profile name. If it contains the key ''SURNAME'' it will be replaced with your profile surname.*/"Salutation":"Ehi NAME",/*MeteoParameterToTheSalutation - empty to disable it.*/"MeteoParameterToTheSalutation":"","DescriptionMeteoToTheSalutationActive": "True","RemindersActive": "False", "TimeToResetInSeconds": 172800, "TimeToEhiTimeoutInSeconds": 15, "WakeUpScreenAfterEhiActive": "True", "GoogleCalendarAccount": "daniele.marassi", "MessagingActive": "True", "NicknamesInJson":"[\"NAME\",\"Amore\"]"}}', CAST(N'2022-01-02T12:12:06.000' AS DateTime))
GO
INSERT [auth].[Users] ([Id], [UserName], [Name], [Surname], [CustomizeParams], [InsDateTime]) VALUES (8, N'daniele.marassi.phone1@gmail.com', N'Daniele', N'Marassi', N'{"General":{"PageSize":"5","Culture":"it-IT"},"Speech":{"HostsArray":"[\"Salotto\",\"Soggiorno\"]","HostDefault":"Salotto","ListeningWord1":"Ehi","ListeningWord2":"cortana","ListeningAnswer":"si dimmi",/*Salutation - If it contains the key ''NAME'' it will be replaced with your profile name. If it contains the key ''SURNAME'' it will be replaced with your profile surname.*/"Salutation":"Ehi NAME",/*MeteoParameterToTheSalutation - empty to disable it.*/"MeteoParameterToTheSalutation":"","DescriptionMeteoToTheSalutationActive": "True","RemindersActive": "False", "TimeToResetInSeconds": 172800, "TimeToEhiTimeoutInSeconds": 15, "WakeUpScreenAfterEhiActive": "False", "GoogleCalendarAccount": "daniele.marassi", "MessagingActive": "False", "NicknamesInJson":"[\"NAME\",\"Amore\"]"}}', CAST(N'2023-09-20T14:52:28.000' AS DateTime))
GO
INSERT [auth].[Users] ([Id], [UserName], [Name], [Surname], [CustomizeParams], [InsDateTime]) VALUES (9, N'daniele.marassi.service1@gmail.com', N'Daniele', N'Marassi', N'{"General":{"PageSize":"5","Culture":"it-IT"},"Speech":{"HostsArray":"[\"Salotto\",\"Soggiorno\"]","HostDefault":"Soggiorno","ListeningWord1":"Ehi","ListeningWord2":"cortana","ListeningAnswer":"si dimmi",/*Salutation - If it contains the key ''NAME'' it will be replaced with your profile name. If it contains the key ''SURNAME'' it will be replaced with your profile surname.*/"Salutation":"Ehi NAME",/*MeteoParameterToTheSalutation - empty to disable it.*/"MeteoParameterToTheSalutation":"","DescriptionMeteoToTheSalutationActive": "True","RemindersActive": "False", "TimeToResetInSeconds": 172800, "TimeToEhiTimeoutInSeconds": 15, "WakeUpScreenAfterEhiActive": "True", "GoogleCalendarAccount": "daniele.marassi", "MessagingActive": "False", "NicknamesInJson":"[\"NAME\",\"Amore\"]"}}', CAST(N'2022-01-02T12:12:06.000' AS DateTime))
GO
...
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (12, N'Volume:_al_n_percento', N'[["volume"], ["a", "al"], ["più", "alza", "aumenta"]]', N'C:\Program Files (x86)\Commands\Volume\volume_with_percentage.exe', NULL, N'All', N'["ok","va bene","certo","bene"]', 1, 4, NULL, N'/Images/Shortcuts/volume-percentage.png', 0, N'RunExeWithNumericParameter', 1, N'SystemDialogueRunExe', 0, NULL, 0, CAST(N'2021-08-14T23:14:07.000' AS DateTime), 1, N'Volume', 0, 0)
GO
...
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (26, N'Spotify:_Tango_Nuevo', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"],["tango"],["nuevo"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:36A11xexKdLaMZWpUzLq2O;486 490 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 4, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:56:31.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (27, N'Spotify:_Tango_Tradizionale', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"],["tango"],["tradizionale"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:2LOKmWnLCkiizHwiljfhX9;486 490 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 4, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:57:48.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (28, N'Spotify:_2000', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"], ["2000"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:3W4uVzChUd70KYwpAJEBDo;486 490 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 4, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:59:01.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
...
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (30, N'Shutdown_PC', N'[["pc", "computer"], ["spegni", "chiudi", "shutdown"]]', N'C:\Program Files (x86)\Shut\Shut.exe', N'shutdown', N'Salotto', N'["ok","va bene","certo","bene"]', 1, 4, NULL, N'/Images/Shortcuts/shutdown.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-10-25T23:02:13.000' AS DateTime), 1, N'PC', 0, 0)
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (31, N'Spotify:_Dance', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"], ["dance"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:0XNgv74fN0N4usS4vLjNAA?si=5041b18841e7434d;486 490 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 4, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:56:31.000' AS DateTime), 1, N'Spotify', 0, 1)
GO
...
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (43, N'Spotify:_Tango_Nuevo', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"],["tango"],["nuevo"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:36A11xexKdLaMZWpUzLq2O;486 429 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 5, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:56:31.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (44, N'Spotify:_Tango_Tradizionale', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"],["tango"],["tradizionale"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:2LOKmWnLCkiizHwiljfhX9;486 429 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 5, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:57:48.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
...
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (48, N'Spotify:_Dance', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"], ["dance"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:0XNgv74fN0N4usS4vLjNAA?si=5041b18841e7434d;486 429 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 5, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:56:31.000' AS DateTime), 1, N'Spotify', 0, 1)
GO
...
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (64, N'Shutdown_PC', N'[["pc", "computer"], ["spegni", "chiudi", "shutdown"]]', N'C:\Program Files (x86)\Shut\Shut.exe', N'shutdown', N'Salotto', N'["ok","va bene","certo","bene"]', 1, 5, NULL, N'/Images/Shortcuts/shutdown.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2022-01-23T10:02:11.610' AS DateTime), 1, N'PC', 0, 0)
GO
...
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (92, N'Spotify:_Settimanale', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"], ["settimanale","settimana","week"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:37i9dQZEVXcF4NN2cdsVc3;486 490 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 4, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:59:01.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (93, N'Spotify:_Blues', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"], ["blues"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:37i9dQZF1EQpz3DZCEoX3g;486 490 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 4, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:59:01.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (94, N'Spotify:_Soft', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"], ["soft"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:5UzZuu84hjwAQEyaGKBYUF;486 490 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 4, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:59:01.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (95, N'Spotify:_Settimanale', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"], ["settimanale","settimana","week"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:37i9dQZEVXcF4NN2cdsVc3;486 429 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 5, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:59:01.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (96, N'Spotify:_Blues', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"], ["blues"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:37i9dQZF1EQpz3DZCEoX3g;486 429 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 5, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:59:01.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (97, N'Spotify:_Soft', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"], ["soft"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:5UzZuu84hjwAQEyaGKBYUF;486 429 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 5, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:59:01.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
...
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (104, N'Spotify:_Tango_Nuevo', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"],["tango"],["nuevo"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:36A11xexKdLaMZWpUzLq2O;486 429 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 8, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:56:31.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (105, N'Spotify:_Tango_Tradizionale', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"],["tango"],["tradizionale"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:2LOKmWnLCkiizHwiljfhX9;486 429 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 8, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:57:48.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
...
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (107, N'Spotify:_Dance', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"], ["dance"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:0XNgv74fN0N4usS4vLjNAA?si=5041b18841e7434d;486 429 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 8, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:56:31.000' AS DateTime), 1, N'Spotify', 0, 1)
GO
...
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (113, N'Shutdown_PC', N'[["pc", "computer"], ["spegni", "chiudi", "shutdown"]]', N'C:\Program Files (x86)\Shut\Shut.exe', N'shutdown', N'Salotto', N'["ok","va bene","certo","bene"]', 1, 8, NULL, N'/Images/Shortcuts/shutdown.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2022-01-23T10:02:11.610' AS DateTime), 1, N'PC', 0, 0)
GO
...
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (115, N'Spotify:_Settimanale', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"], ["settimanale","settimana","week"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:37i9dQZEVXcF4NN2cdsVc3;486 429 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 8, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:59:01.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (116, N'Spotify:_Blues', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"], ["blues"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:37i9dQZF1EQpz3DZCEoX3g;486 429 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 8, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:59:01.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (117, N'Spotify:_Soft', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"], ["soft"]]', N'C:\Program Files (x86)\Spotify\SpotifyLaunch.vbs;C:\Program Files (x86)\Commands\MoveMouseAndClick\MoveMouseAndClick.exe', N'spotify:user:dm:playlist:5UzZuu84hjwAQEyaGKBYUF;486 429 15000', N'All', N'["ok","va bene","certo","bene"]', 1, 8, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:59:01.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (118, N'Dispaly:_Principale', N'[["monitor","schermo","display"],["principale","uno","1","primo","primario","grande"]]', N'C:\Windows\System32\DisplaySwitch.exe', N'1', N'All', NULL, 1, 0, NULL, N'/Images/Shortcuts/monitor.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2022-01-08T10:10:37.000' AS DateTime), 1, N'App', 0, 0)
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (119, N'Dispaly:_Secondario', N'[["monitor","schermo","display"],["secondario","due","2","secondo","piccolo"]]', N'C:\Windows\System32\DisplaySwitch.exe', N'4', N'All', NULL, 1, 0, NULL, N'/Images/Shortcuts/monitor.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2022-01-08T10:10:37.000' AS DateTime), 1, N'App', 0, 0)
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (120, N'Spotify:Open', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"]]', N'C:\Program Files (x86)\Spotify\App\Spotify.exe', N'', N'All', N'["ok","va bene","certo","bene"]', 1, 4, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:59:01.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (121, N'Spotify:Open', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"]]', N'C:\Program Files (x86)\Spotify\App\Spotify.exe', N'', N'All', N'["ok","va bene","certo","bene"]', 1, 5, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:59:01.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
INSERT [dbo].[WebSpeeches] ([Id], [Name], [Phrase], [Operation], [Parameters], [Host], [Answer], [FinalStep], [UserId], [ParentIds], [Ico], [Order], [Type], [OperationEnable], [SubType], [Step], [StepType], [ElementIndex], [InsDateTime], [Groupable], [GroupName], [GroupOrder], [HotShortcut]) VALUES (122, N'Spotify:Open', N'[["open","apri", "esegui", "start", "execute", "avvia","show", "mostrami"],["spotify"]]', N'C:\Program Files (x86)\Spotify\App\Spotify.exe', N'', N'All', N'["ok","va bene","certo","bene"]', 1, 8, NULL, N'/Images/Shortcuts/spotify.png', 0, N'RunExe', 1, NULL, 0, NULL, 0, CAST(N'2021-08-16T09:59:01.000' AS DateTime), 1, N'Spotify', 0, 0)
GO
SET IDENTITY_INSERT [dbo].[WebSpeeches] OFF
GO
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__UserRole__F9B8A48B05C457CE]    Script Date: 08/02/2025 16:28:57 ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__UserRole__F9B8A48B1C4A48B2]    Script Date: 08/02/2025 16:28:57 ******/
ALTER TABLE [auth].[UserRoleTypes] ADD UNIQUE NONCLUSTERED 
(
	[Type] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__Users__C9F284564B922F94]    Script Date: 08/02/2025 16:28:57 ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__Users__C9F2845676246339]    Script Date: 08/02/2025 16:28:57 ******/
ALTER TABLE [auth].[Users] ADD UNIQUE NONCLUSTERED 
(
	[UserName] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__WebSpeec__A20D08328D13A12F]    Script Date: 08/02/2025 16:28:57 ******/
