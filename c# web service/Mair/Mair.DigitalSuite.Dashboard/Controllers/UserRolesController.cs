...
namespace Mair.DigitalSuite.Dashboard.Controllers
{
    public class UserRolesController : Controller
    {
            ...
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                ...
                try
                {
                    ...
                    else if (!String.IsNullOrEmpty(searchString))
                    {
                        ...
                        var _userRoleTypeIds = userRoleTypes.Where(_ => _.TypeName.ToUpper().Contains(searchString.ToUpper().Trim())).Select(_ => _.Id).ToList();
        ...
        public async Task<IActionResult> Create([Bind("Id,UserId,UserRoleTypeId")] UserRoleDto dto)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,UserId,UserRoleTypeId")] UserRoleDto dto)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                if (ModelState.IsValid)
