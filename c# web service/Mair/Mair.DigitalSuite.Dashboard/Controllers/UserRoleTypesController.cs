...
namespace Mair.DigitalSuite.Dashboard.Controllers
{
    public class UserRoleTypesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string currentFilter, string searchString, int? page)
        {
            ...
            {
                var result = new UserRoleTypeResult() { Data = new List<UserRoleTypeDto>() { }, Successful = false };
        ...
        public async Task<IActionResult> Create([Bind("Id,Type")] UserRoleTypeDto dto)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Type")] UserRoleTypeDto dto)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                if (ModelState.IsValid)
