...
namespace Mair.DigitalSuite.Dashboard.Controllers
{
    public class AuthenticationsController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string currentFilter, string searchString, int? page)
        {
            ...
            {
                var result = new AuthenticationResult() { Data = new List<AuthenticationDto>() { }, Successful = false };
        ...
        public async Task<IActionResult> Create([Bind("Id,Password,PasswordExpiration,PasswordExpirationDays,Enable,UserId")] AuthenticationDto dto)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Password,PasswordExpiration,PasswordExpirationDays,Enable,UserId")] AuthenticationDto dto)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                if (ModelState.IsValid)
