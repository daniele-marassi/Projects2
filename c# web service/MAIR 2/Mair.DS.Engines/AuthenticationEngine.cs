...
{
    public class AuthenticationEngine : BaseEngine<Authentication>
    {
        public AuthenticationEngine(AutomationContext context)
            : base( new AuthenticationRepository(context))
        {
