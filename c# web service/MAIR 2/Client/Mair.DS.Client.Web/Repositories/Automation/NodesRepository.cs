        ...
        public async Task<NodeResult> GetAllNodes(string token)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                ...
                try
                {
                    ...
                    var result = await utility.CallApi(HttpMethod.Get, Defaults.BaseUrl, "api/nodes", null, token);
                    ...
                    else
                    {
                        ...
                        response.Data.AddRange(JsonConvert.DeserializeObject<List<NodeDto>>(content));
        ...
        public async Task<NodeResult> GetNodesById(long id, string token)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                ...
                try
                {
                    ...
                    var result = await utility.CallApi(HttpMethod.Get, Defaults.BaseUrl, "api/nodes", keyValuePairs, token);
                    var content = await result.Content.ReadAsStringAsync();
                    ...
                    {
                        //response = JsonConvert.DeserializeObject<NodeResult>(content);
                        response.Data.Add(JsonConvert.DeserializeObject<NodeDto>(content));
                        response.Successful = true;
                        response.ResultState = ResultType.Found;
                        response.Message = "";
                    }
        ...
        public async Task<NodeResult> UpdateNode(NodeDto dto, string token)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                ...
                try
                {
                    ...
                    var result = await utility.CallApi(HttpMethod.Put, Defaults.BaseUrl, "api/nodes", keyValuePairs, token);
                    var content = await result.Content.ReadAsStringAsync();
        ...
        public async Task<NodeResult> AddNode(NodeDto dto, string token)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                ...
                try
                {
                    ...
                    var result = await utility.CallApi(HttpMethod.Post, Defaults.BaseUrl, "api/nodes", keyValuePairs, token);
                    var content = await result.Content.ReadAsStringAsync();
        ...
        public async Task<NodeResult> DeleteNodeById(long id, string token)
        {
            using (var logger = new NLogScope(classLogger, nLogUtility.GetMethodToNLog(MethodInfo.GetCurrentMethod())))
            {
                ...
                try
                {
                    ...
                    var result = await utility.CallApi(HttpMethod.Delete, Defaults.BaseUrl, "api/nodes", keyValuePairs, token);
                    var content = await result.Content.ReadAsStringAsync();
